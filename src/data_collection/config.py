...
def parse_data_collection_args() -> DataCollectionConfig:
    ...
    parser = argparse.ArgumentParser(description="Data collection for improved example generation")
    
    # Experiment setup
    parser.add_argument('--experiment-id', required=True,
                       help='Unique identifier for this experiment')
    parser.add_argument('--leaf-examples-per-iteration', type=int, required=True,
                       help='Number of leaf examples to generate per iteration')
    parser.add_argument('--parent-examples-per-iteration', type=int, required=True,
                       help='Number of parent examples to generate per iteration')
    parser.add_argument('--max-parent-examples', type=int, default=20,
                       help='Maximum total parent examples to accumulate (default: 20)')
    parser.add_argument('--max-iterations', type=int, required=True,
                       help='Maximum number of iterations to run')
    
    # Depth configuration
    parser.add_argument('--sample-max-depth', type=int, required=True,
                       help='Maximum depth for sample session generation')
    parser.add_argument('--parent-max-depth', type=int, default=1,
                       help='Maximum depth for parent example generation (default: 1)')
    parser.add_argument('--leaf-max-depth', type=int, required=True,
                       help='Maximum depth for leaf example generation')
    
    # File paths
    parser.add_argument('--writing-prompts-path', required=True,
                       help='Path to file containing writing prompts (one per line)')
    parser.add_argument('--seed-leaf-examples', required=True,
                       help='Path to seed leaf examples XML file')
    parser.add_argument('--seed-parent-examples', required=True,
                       help='Path to seed parent examples XML file')
    parser.add_argument('--leaf-readme-path', required=True,
                       help='Path to leaf generation README file')
    parser.add_argument('--parent-readme-path', required=True,
                       help='Path to parent generation README file')
    
    # Character limits
    parser.add_argument('--parent-total-char-limit', type=int, default=2000,
                       help='Total character limit for parent examples (default: 2000)')
    parser.add_argument('--parent-submit-char-limit', type=int, default=500,
                       help='Character limit for parent submit elements (default: 500)')
    
    # Web UI
    parser.add_argument('--web-ui-port', type=int, default=5000,
