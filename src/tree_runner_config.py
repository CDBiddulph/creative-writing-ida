...
def parse_args() -> Tuple[TreeRunnerConfig, str]:
    ...
    parser.add_argument(
        "--model", required=True, help="Model name for SessionXmlGenerator"
    )
    parser.add_argument(
        "--max-depth",
        type=int,
    ...
    parser.add_argument(
        "--leaf-readme-path", required=True, help="Path to leaf README file"
    )
    parser.add_argument(
        "--parent-readme-path", required=True, help="Path to parent README file"
    )
    parser.add_argument(
        "--leaf-examples-xml-path", help="Optional path to leaf examples XML file"
    )
    parser.add_argument(
