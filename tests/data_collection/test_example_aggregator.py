  ...
  <session>
    ...
    def test_copies_seed_examples_for_iteration_zero(self, mock_config):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            seed_parent.write_text("<sessions><session>parent seed</session></sessions>")
            ...
            parent_content = (iter_path / "examples" / "parent_examples.xml").read_text()
